...
const JADWAL_DOKTER_DATA: JadwalDokter[] = [
    ...
    { id: 22, nama: "drg. Ryan Ferdinand, Sp.RKG., MARS.", spesialisasi: "Spesialis Radiologi Kedokteran Gigi", hari: "Selasa", tanggal: getTanggalMingguIni("Selasa"), jamMulai: "-", jamSelesai: "-", kuotaTotal: 5, kuotaTersisa: 5, profileImg: "/profile6.jpg" },
    { id: 38, nama: "drg. Ryan Ferdinand, Sp.RKG., MARS.", spesialisasi: "Spesialis Radiologi Kedokteran Gigi", hari: "Rabu", tanggal: getTanggalMingguIni("Rabu"), jamMulai: "-", jamSelesai: "-", kuotaTotal: 5, kuotaTersisa: 5, profileImg: "/profile6.jpg" },
    { id: 39, nama: "drg. Ryan Ferdinand, Sp.RKG., MARS.", spesialisasi: "Spesialis Radiologi Kedokteran Gigi", hari: "Kamis", tanggal: getTanggalMingguIni("Kamis"), jamMulai: "-", jamSelesai: "-", kuotaTotal: 5, kuotaTersisa: 5, profileImg: "/profile6.jpg" },
    { id: 40, nama: "drg. Ryan Ferdinand, Sp.RKG., MARS.", spesialisasi: "Spesialis Radiologi Kedokteran Gigi", hari: "Jumat", tanggal: getTanggalMingguIni("Jumat"), jamMulai: "-", jamSelesai: "-", kuotaTotal: 5, kuotaTersisa: 5, profileImg: "/profile6.jpg" },
    { id: 41, nama: "drg. Ryan Ferdinand, Sp.RKG., MARS.", spesialisasi: "Spesialis Radiologi Kedokteran Gigi", hari: "Sabtu", tanggal: getTanggalMingguIni("Sabtu"), jamMulai: "-", jamSelesai: "-", kuotaTotal: 5, kuotaTersisa: 5, profileImg: "/profile6.jpg" },
    { id: 42, nama: "drg. Ryan Ferdinand, Sp.RKG., MARS.", spesialisasi: "Spesialis Radiologi Kedokteran Gigi", hari: "Minggu", tanggal: getTanggalMingguIni("Minggu"), jamMulai: "-", jamSelesai: "-", kuotaTotal: 5, kuotaTersisa: 5, profileImg: "/profile6.jpg" },
